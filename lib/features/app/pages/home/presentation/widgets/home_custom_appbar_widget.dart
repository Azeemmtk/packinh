...
import 'package:packinh/features/app/pages/account/presentation/screens/profile_screen.dart';
...
class HomeCustomAppbarWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => getIt<UserDetailsBloc>()..add(FetchUserDetails(uid: CurrentUser().uId!)),
      child: Container(
                        ...
                        return Container(
                          ...
                          child: Row(
                            children: [
                              CircleAvatar(
                                radius: 16,
                                backgroundImage: state is UserDetailsLoaded &&
