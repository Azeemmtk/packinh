...
class OccupantDetailsScreen extends StatelessWidget {
  ...
  const OccupantDetailsScreen({super.key, required this.occupantId, required this.hostelName, required this.roomType});
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                    image: NetworkImage(occupant.idProofUrl ??
                                        imagePlaceHolder),
                                    fit: BoxFit.cover),
                              ),
                            ),
                            ...
                            DetailsRowWidget(
                              title: 'Hostel name',
                              value:
                                  hostelName, // Fetch from hostel if needed, hardcoded for now
                              isBold: true,
                            ),
                            height5,
                            DetailsRowWidget(
                                title: 'Room type',
                                value: roomType), // Assume or fetch
                            height50,
